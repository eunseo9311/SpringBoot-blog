...
import com.yourssu.application.request.RefreshTokenRequestDTO;
...
import com.yourssu.application.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<SignupResponseDTO> signup(@Valid @RequestBody SignupRequestDTO signupRequest) {
        ...
        } catch (IllegalArgumentException | com.yourssu.application.exception.AuthException e) {
